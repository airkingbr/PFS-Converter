...
- Nova opção em Advanced Options: **Gerar index do AMPR** — gera `ampr_emu.index` na raiz da pasta do dump **antes** de empacotar, garantindo que o index fique incluído na imagem final
